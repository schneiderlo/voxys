...
class Model:
    ...
    def finish(self, material, surface_shading=shading.FLAT):
        ...
        for obj in self.objects:
            ...
            bm.to_mesh(obj.data); bm.free()
            geo.activate(obj)
            if surface_shading==shading.MANUFACTURED:shading_checks.append(shading.apply(obj))
        ...
        if surface_shading==shading.MANUFACTURED:triangulate.keep_custom_normals=True
