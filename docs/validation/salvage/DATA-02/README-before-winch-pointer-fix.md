...
**Result:** the optimized Bazel target and all 16 focused native test cases pass.
The refreshed standalone build also passes all 16 cases with the full repository
GCC warnings, `-Werror`, undefined-behavior sanitizer and float-cast-overflow
sanitizer. No sanitizer diagnostics occurred.
...
| `src/game/construction/part_catalog.cpp` | `12ed95f3e466da436144e8e63137065c6a25279c4771228b44e0031f673ef942` |
| `tests/test_part_catalog.cpp` | `22b94d01833318708c622e90b9ca71fc6a31ce2f24363462c2398e4c89e47ed8` |

Host: Linux x86_64. Compiler: GCC 15.2.0 at
`/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0/bin/g++`.

Actual compilation, with that compiler substituted for `g++`:
...
The current source also passes the integrated CMake target and all 16 focused
...
target. The final standalone sanitizer run used the current source hashes above.
