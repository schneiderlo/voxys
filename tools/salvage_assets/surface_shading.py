...
Version 1 uses area/angle weighted normals and analytical torus normals.
Version 2 adds analytical rounded-box/cylinder normals to preserve flat panels
and caps. Components with socket cuts retain the weighted fallback, with sharp
boundaries above 50 degrees. This is a candidate recipe, not asset acceptance;
compare exported geometry and real engine views for every selected part.
"""
import math
