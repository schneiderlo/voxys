...
def main():
    ...
    sources = ["src/game/construction/construction_types.cpp", "src/game/construction/part_catalog.cpp",
               ...
               "src/physics/rigid_mass_frame.cpp", "tests/test_rigid_mass_frame.cpp",
               "src/physics/authored_shape.cpp", "src/physics/authored_shape_pool.cpp", "tests/test_authored_shape.cpp",
               "tests/test_construction_types.cpp", "tests/test_part_catalog.cpp",
    ...
    headers = ["src/game/construction/construction_types.hpp", "src/game/construction/part_catalog.hpp",
               ...
               "src/game/construction/compiled_assembly.hpp", "src/core/sha256.hpp", "src/physics/rigid_mass_frame.hpp",
               "src/physics/authored_shape.hpp", "src/physics/authored_shape_pool.hpp", "src/physics/shape_handle.hpp",
    ...
    try:
        ...
        if not count or int(count.group(1)) != 130 or "[  SKIPPED ]" in log or "DISABLED TEST" in log:
            raise RuntimeError("expected all 130 shape/mass/assembly/build/catalog/grid cases, zero skips/disabled")
